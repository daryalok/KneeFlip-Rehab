...
- A claim to treat, prevent, cure, or diagnose a medical condition

## Supported Versions

This project is an early prototype. Security and safety fixes should target the latest `main` branch until formal releases are created.
